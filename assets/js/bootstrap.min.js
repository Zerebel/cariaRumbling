...
$(function () {
  ...
  var footerclic = $("body");
  footerclic.on("click", "footer", null, function () {
    navMain.collapse("hide");
  });

  var navclic = $("body");
  navclic.on("click", ".navbar-brand", null, function () {
    navMain.collapse("hide");
  });

  var carol_mob = $("body");
  carol_mob.on("click", ".carol-mobile", null, function () {
    navMain.collapse("hide");
  });

  var carol_m = $("body");
  carol_m.on("click", "section", null, function () {
    navMain.collapse("hide");
  });
  
  var carol = $("body");
  carol.on("click", "button", null, function () {
    navMain.collapse("hide");
  });

  var carol_ = $("body");
  carol_.on("click", "#main-container", null, function () {
    navMain.collapse("hide");
  });

  var carol_ = $("body");
  carol_.on("click", ".top-page", null, function () {
    navMain.collapse("hide");
  });
});
